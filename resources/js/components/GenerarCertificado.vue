                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div
                                    class="text-dark stateCertificado_id"
                                    :class="stateCertificado>80 ? 'bg-success' : stateCertificado>50 ? 'bg-warning' : 'bg-danger' "
                                >
                                    <strong><label>Stock de Certificaciones</label></strong>
                                    <center><h4 v-text="stateCertificado"></h4></center>
                                </div>
                                </div>
                        </div>
