            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> CERTIFICADO DIGITAL 
            ...
            <template v-if="listado==1">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" v-model="bpdsi" @keyup.enter="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia)" class="form-control" placeholder="SERVICIO" ></div>
                            <label class="col-md-4 form-control-label" for="nombre">CLIENTE: </label> 
                            <div class="col-md-5">
                                <input type="text" v-model="bempresa" @keyup.enter="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia)" class="form-control" placeholder="CLIENTE" ></div>
                            <label class="col-md-4 form-control-label" for="solicitante">CERTIFICADO: </label> 
                            <div class="col-md-5">
                                    <input type="text" v-model="bnumero" @keyup.enter="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia)" class="form-control" placeholder="CERTIFICADO"></div>
                            <label class="col-md-4 form-control-label" for="solicitante">NOMBRE PROFESIONAL: </label> 
                            <div class="col-md-5">
                                    <input type="text" v-model="bnpersona" @keyup.enter="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia)" class="form-control" placeholder="NOMBRE PROFESIONAL"></div>
                            <label class="col-md-4 form-control-label" for="solicitante">APELLIDO PROFESIONAL: </label> 
                            <div class="col-md-5">
                                    <input type="text" v-model="bapersona" @keyup.enter="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia)" class="form-control" placeholder="TIPO CERTIFICADO">
                            </div>
                            <label class="col-md-4 form-control-label" for="solicitante">TIPO CERTIFICADO: </label> 
                            <div class="col-md-5">
                                    <input type="text" v-model="btipo_certificado" @keyup.enter="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia)" class="form-control" placeholder="TIPO CERTIFICADO"></div>
                            ...
                            <div class="col-md-5">
                                ...
                                <button type="submit" @click="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia)" class="btn btn-primary"><i class="fa fa-search"></i>Buscar</button>
                            </div> 
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                    <tr v-for="certificado in arrayCertificado" :key="certificado.id">
                                        <td><template v-if="certificado.condicion==1">
                                    ...
                                    <td>
                                        <template v-if="certificado.estado==0 || certificado.estado==1">
                                            <button type="button" @click="cargarPdfemisionSF(certificado.id)" class="btn btn-info btn-sm" >
                                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M4 0h5.5v1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h1V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2z"/>
                                                <path d="M9.5 3V0L14 4.5h-3A1.5 1.5 0 0 1 9.5 3z"/>
                                                <path fill-rule="evenodd" d="M10.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
                                    ...
                                    <td v-text="certificado.tipo_certificados"></td>
                        ...
                        <nav>
                            <ul class="pagination">
                                <li class="page-item" v-if="pagination.current_page > 1">
                                    <a class="page-link" href="#" @click.prevent="cambiarPagina(pagination.current_page - 1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia)">Ant</a>
                                </li>
                                <li class="page-item" v-for="page in pagesNumber" :key="page" :class="[page == isActived ? 'active': '']">
                                    <a class="page-link" href="#" @click.prevent="cambiarPagina(page,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia)" v-text="page"></a>
                                </li>
                                <li class="page-item" v-if="pagination.current_page < pagination.last_page">
                                    <a class="page-link" href="#" @click.prevent="cambiarPagina(pagination.current_page+1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia)">Sig</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <template v-else-if="listado==0">
                <form @submit.prevent="formData" method="post" enctype="multipart/form-data" class="form-horizontal">  
                    ...
                    <div class="card-body">
                     ...
                     <button v-if="tipoAccion==1" class="btn btn-primary">Actualizar</button>&nbsp;&nbsp;
                     ...
                     <button v-if="tipoAccion==2" class="btn btn-primary">Iniciar Emisión Certificado</button>
                        </div>             
                    </div>
                </form> 
            </template>
...
export default {
    name: 'app',
        ...
        methods : {
            listarCertificado(page,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia){
                let me=this;
                var url= '/consultaCerti?page=' + page + '&bpdsi='+ bpdsi+ '&bempresa='+ bempresa
                + '&bnumero='+ bnumero+ '&bnpersona='+ bnpersona + '&bapersona='+ bapersona+ '&btipo_certificado='+ btipo_certificado+ '&bvigencia='+ bvigencia;
            ...
            cambiarPagina(page,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia){
                let me = this;
                //Actualiza la pagina actual
                me.pagination.current_page = page;
                //envia peticion para visualizar la data de esa pagina 
                me.listarCertificado(page,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bvigencia);
            },
            vistaPrevia(){
                this.listado=2;
            },
            ...
            formData(){
                ...
                const formData = new FormData();
                formData.set('id', this.certificado_id);
                formData.set('iddesignacion', this.iddesignacion);
                formData.set('persona_id', this.persona_id);
                formData.set('tipo_certificado_id', this.tipo_certificado_id);
                formData.set('firma_id', this.firma_id);
                formData.set('lote_id', this.lote_id);
                formData.set('idcarne', this.idcarne);
                formData.set('dni', this.dni);
                formData.set('nombre', this.nombre);
                formData.set('apellido', this.apellido);
                formData.set('persona', this.persona);
                formData.set('nombre_lote', this.nombre_lote);
                formData.set('cond_equipo', this.cond_equipo);
                formData.set('dias', this.dias);
                formData.set('numero', this.numero);
                formData.set('pdsi', this.pdsi);
                formData.set('empresa', this.empresa);
                formData.set('certificado', this.certificado);
                formData.set('designacion', this.designation);
                formData.set('equipo', this.equipo);
                formData.set('equipoes', this.equipoes);
                formData.set('tipo_certificados', this.tipo_certificados);
                formData.set('level', this.level);
                formData.set('normativa', this.normativa);
                formData.set('normativaes', this.normativaes);
                formData.set('horas', this.horas);
                formData.set('fecha_emision', this.fecha_emision);
                formData.set('fecha_emision2', this.fecha_emision2);
                formData.set('fecha_emision3', this.fecha_emision3);
                formData.set('fecha_emision4', this.fecha_emision4);
                formData.set('fecha_emision5', this.fecha_emision5);
                formData.set('fecha_emision6', this.fecha_emision6);
                formData.set('fecha_emision7', this.fecha_emision7);
                formData.set('prj_id', this.prj_id);
                formData.set('lugarEva', this.lugarEva);
                formData.set('capacidadC', this.capacidadC);
                formData.set('resultado', this.resultado);
                formData.set('puntaje', this.puntaje);
                formData.set('separacion', this.separacion);
                formData.set('informe', this.informe);
                formData.set('archivo',this.imagen);

                if (this.certificado_id == '') {
                    axios.post('/certificadoC/registrar', formData).then(function (response) {
                        me.cerrarModal();
                        me.listarCertificado(1, '', '', '', '', '', '','');
                        indi = 1;
                    }).catch(function (error) {
                    ...
                    axios.post('/certificadoC/actualizar', formData).then(function (response) {
                        me.cerrarModal();
                        me.listarCertificado(1, '', '', '', '', '', '','');
        ...
        mounted() {
           this.listarCertificado(1,this.bpdsi,this.bempresa,this.bnumero,this.bnpersona,this.bapersona,this.btipo_certificado,this.bvigencia);
        }
    }
</script>
<style>
