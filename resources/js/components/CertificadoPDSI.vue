<template>
  <main class="main">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Servicios - Generacion de Certificados
                        <button type="button" @click="verCertificaciones('tipo_certificado','registrar')" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                            <input type="text" v-model="pdsiB" @keyup.enter="listarServicios(1,pdsiB,empresaB,criterio)" class="form-control" placeholder="PDSI"></div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-4 form-control-label" for="nombre">Empresa: </label> 
                    <div class="col-md-6">
                            <input type="text" v-model="empresaB" @keyup.enter="listarServicios(1,pdsiB,empresaB,criterio)" class="form-control" placeholder="Empresa"></div>
                            <button type="submit" @click="listarServicios(1,pdsiB,empresaB,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Search</button>
                    </div>
                        ...
                        <tbody>
                            <tr v-for="servicio in arrayServicio" :key="servicio.id">
                                <td>
                                    ...
                                    <button type="button" @click="verCertificaciones('servicio','actualizar',servicio)" class="btn btn-warning btn-sm" >
                                        <i class="icon-eye"></i>
                                    </button> &nbsp;
                                ...
                                <td v-text="servicio.PDSI"></td>
                                <td v-text="servicio.empresa"></td>
                                <td> <div v-if="servicio.estado">
                    ...
                    <nav>
                        <ul class="pagination">
                            <li class="page-item" v-if="pagination.current_page > 1">
                                <a class="page-link" href="#" @click.prevent="cambiarPaginaS(pagination.current_page - 1,pdsiB,empresaB,criterio)">Ant</a>
                            </li>
                            <li class="page-item" v-for="page in pagesNumber" :key="page" :class="[page == isActived ? 'active': '']">
                                <a class="page-link" href="#" @click.prevent="cambiarPaginaS(page,pdsiB,empresaB,criterio)" v-text="page"></a>
                            </li>
                            <li class="page-item" v-if="pagination.current_page < pagination.last_page">
                                <a class="page-link" href="#" @click.prevent="cambiarPaginaS(pagination.current_page+1,pdsiB,empresaB,criterio)">Sig</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <template v-if="listado==1">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                    <input type="text" v-model="bnumero" @keyup.enter="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bnestadoEval)" class="form-control" placeholder="Nº Certificate"></div>
                            <label class="col-md-4 form-control-label" for="solicitante">Name Professional: </label> 
                            <div class="col-md-5">
                                    <input type="text" v-model="bnpersona" @keyup.enter="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bnestadoEval)" class="form-control" placeholder="Name Professional"></div>
                            
                            <label class="col-md-4 form-control-label" for="solicitante">Surname Professional: </label> 
                            <div class="col-md-5">
                                    <input type="text" v-model="bapersona" @keyup.enter="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bnestadoEval)" class="form-control" placeholder="Surname Professional"></div>
                            <label class="col-md-4 form-control-label" for="solicitante">Certificate type: </label> 
                            <div class="col-md-5">
                                    <input type="text" v-model="btipo_certificado" @keyup.enter="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bnestadoEval)" class="form-control" placeholder="Certificate type"></div>
                                    
                            
                            <label class="col-md-4 form-control-label" for="solicitante">Estado de Evaluación: </label> 
                            <div class="col-md-5">
                                    <select v-model="bnestadoEval" class="form-control col-md-12">
                                      <option value="">Todos</option>
                                      <option value="1">En Evaluación</option>
                                      <option value="2">Falta Sesión Práctica</option>
                                      <option value="3">Falta Sesión Teórica</option>
                                      <option value="4">Completado</option>
                                      <option value="5">Emitido</option>
                                      <option value="6">Reevaluación</option>
                                      <option value="7">Revalidación Completada</option>
                                      <option value="8">Carné Revalidación Emitido</option>
                                                                          </select>
                                    <button type="submit" @click="listarCertificado(1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bnestadoEval)" class="btn btn-primary"><i class="fa fa-search"></i> Search</button>
                                </div>                                          
                            </div>
                                </div>
                        </div>
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                    <tr v-for="certificado in arrayCertificado" :key="certificado.id">
                                        <td><template v-if="certificado.id_evaluacion==5 || certificado.id_evaluacion==4">
                                                <template v-if="certificado.condicion==1">
                                            ...
                                            <template v-if="certificado.condicion==2">
                                                ...
                                                <template v-if="certificado.estado_edi==2">
                                                </template>
                                                <template v-else>
                                                <button type="button" class="btn btn-warning btn-sm" @click="Vercarne('certificado','edicioncerti',certificado)">
                                                <i class="icon-check"></i>
                                                </button>
                                                </template>
                                            </template>
                                    ...
                                    <template v-if="certificado.condicion==2 && (certificado.id_evaluacion==5 || certificado.id_evaluacion==4)">
                                     
                                    <td>
                                        <template v-if="certificado.estado==0 || certificado.estado==1">
                                            <button type="button" class="btn btn-info btn-sm" @click="Vercarne('certificado','actualizar',certificado)">
                                                <i class="icon-eye"></i>
                                            </button>
                                        </template>
                                        <template v-else-if="certificado.estado==2">
                                        ...
                                        <template v-else-if="certificado.estado==3">
                                            <button type="button" class="btn btn-success btn-sm" @click="cargarCarnePdfemision(certificado.idcarne)">
                                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-heading" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                                                    <path fill-rule="evenodd" d="M3 8.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5z"/>
                                            ...
                                            <button type="button" class="btn btn-info btn-sm" @click="Vercarne('certificado','reevalidacion',certificado)">
                                                <i class="icon-check"></i>
                                            </button>
                                        </template>
                                        <template v-else-if="certificado.estado==4">
                                            <button type="button" class="btn btn-success btn-sm" @click="cargarCarnePdfemision(certificado.idcarne)">
                                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-heading" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                                                    <path fill-rule="evenodd" d="M3 8.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5z"/>
                                            ...
                                            <button type="button" class="btn btn-warning btn-sm" @click="cargarCarnePdfemision1(certificado.idcarne)">
                                    ...
                                    <template v-if="certificado.id_evaluacion==1">
                                    <td><span class="badge badge-secondary">En Evaluación</span></td>
                                    </template>
                                    <template v-else-if="certificado.id_evaluacion==2">
                                    <td><span class="badge badge-warning">Falta Sesión Práctica</span></td>
                                    </template>
                                    <template v-else-if="certificado.id_evaluacion==3">
                                    <td><span class="badge badge-warning">Falta Sesión Teórica</span></td>
                                    </template>
                                    <template v-else-if="certificado.id_evaluacion==4">
                                    <td><span class="badge badge-info">Completado</span></td>
                                    </template>
                                    <template v-else-if="certificado.id_evaluacion==5">
                                    <td><span class="badge badge-success">Emitido</span></td>
                                    </template>
                                    <template v-else-if="certificado.id_evaluacion==6">
                                    <td><span class="badge badge-danger">Reevaluación</span></td>
                                    </template>
                                    <template v-else-if="certificado.id_evaluacion==7">
                                    <td><span class="badge badge-info">Revalidación Completada</span></td>
                                    </template>
                                    <template v-else-if="certificado.id_evaluacion==7">
                                    <td><span class="badge badge-secondary">Carné Revalidación Emitido</span></td>
                                    </template>
                                    <template v-else>
                                    <td></td>
                                    </template>
                                    ...
                                    <td><template v-if="certificado.id_evaluacion==5 || certificado.id_evaluacion==4">
                                        <div v-if="certificado.condicion==1">
                        ...
                        <nav>
                            <ul class="pagination">
                                <li class="page-item" v-if="pagination.current_page > 1">
                                    <a class="page-link" href="#" @click.prevent="cambiarPaginaS(pagination.current_page - 1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado)">Ant</a>
                                </li>
                                <li class="page-item" v-for="page in pagesNumber" :key="page" :class="[page == isActived ? 'active': '']">
                                    <a class="page-link" href="#" @click.prevent="cambiarPaginaS(page,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado)" v-text="page"></a>
                                </li>
                                <li class="page-item" v-if="pagination.current_page < pagination.last_page">
                                    <a class="page-link" href="#" @click.prevent="cambiarPaginaS(pagination.current_page+1,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado)">Sig</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="form-group row border">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="" id="" v-model="prj_id" class="form-control" >
                            <!--<input type="text" v-model="pdsi" class="form-control"> -->
                            <option v-for="pdsi in pdsi_all" :key="pdsi.prj_id" :value="pdsi.prj_id" v-text="pdsi.nro_pdsi"></option>
                            </select>
                        </div>  
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>>21ton.:</label>
                            <select class="form-control" v-model="toneladas">
             ...
             <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="generateCerti()">Issue Certificate</button>&nbsp;&nbsp;
...
import ClassicEditor from '@ckeditor/ckeditor5-build-classic';
    export default {
        ...
        methods : {
            listarServicios (page,pdsiB,empresaB,criterio){
                let me=this;
                var url= '/servicios?page=' + page + '&buscar='+ pdsiB + '&empresa='+ empresaB;
            ...
            listarCertificado(page,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bnestadoEval){
                let me=this;
                ...
                + '&bnestadoEval='+ bnestadoEval;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.arrayCertificado = respuesta.certificados.data;
                    me.pagination= respuesta.pagination;
                    me.stateCertificado = respuesta.status_certificados.stock;
                    me.pdsi_all = respuesta.pdsi_all;
                })
                .catch(function (error) {
                    // handle error
                    console.log(error);
            ...
            cambiarPagina(page,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado){
                ...
                me.listarCertificado(page,bpdsi,bempresa,bnumero,bnpersona,bapersona,btipo_certificado,bnestadoEval);
            },
            cambiarPaginaS(page,pdsiB,empresaB,criterio){
                let me = this;
                //Actualiza la pagina actual
                me.pagination.current_page = page;
                //envia peticion para visualizar la data de esa pagina 
                me.listarServicios(page,pdsiB,empresaB,criterio);
            },
            ...
            generateCerti(){
                let me = this;
                    axios.put('/certificado/generateCerti',
                    {
                        ...
                        me.listarCertificado(1,this.bpdsi,this.bempresa,'','','','','');
            ...
            actualizarCertificado(){
                    ...
                    let me = this;
                    axios.put('/certificado/actualizar',{
                        'id': this.certificado_id,
                        'iddesignacion':this.iddesignacion,
                        'persona_id': this.persona_id,
                        'tipo_certificado_id': this.tipo_certificado_id,
            ...
            verCertificaciones(servicio, accion, data = []){
                switch(servicio){
                    case "servicio":
                        {
                            switch(accion){
                                ...
                                {
                                    this.listado = 1;
                                    this.bpdsi= data['PDSI'];
                                    this.bempresa= data['empresa'];
                                    this.prj_id = data['id_proj'];
                                    this.listarCertificado(1,this.bpdsi,this.bempresa,'','','','','');
                                    break;
                                }
                            }
                        }
        ...
        mounted() {
           this.listarServicios(1,this.pdsiB,this.empresaB,this.criterio);
        }
    }
</script>
<style>
