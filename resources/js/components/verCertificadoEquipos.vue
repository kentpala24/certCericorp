                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <template v-if="indi==0">
                                ...
                                <div class="col-md-5">
                                    <input type="text" v-model="bempresa" @keyup.enter="listarEquipo(1,bpdsi,bempresa,bnumero,bequipo,bmodelo,bserie)" class="form-control" placeholder="Company" >
                                </div>
                            </template>
                            ...
                            <div class="col-md-5">
                                    ...
                                    <button type="submit" @click="listarEquipo(1,bpdsi,bempresa,bnumero,bequipo,bmodelo,bserie)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                            </div> 
                                </div>
                        </div>
    ...
    components: { vSelect },
        ...
        methods : {
            listarEquipo(page,bpdsi,bempresa,bnumero,bequipo,bmodelo,bserie){
                ...
                this.selectFirma();
                let me=this;
                var url= '/equipoC?page=' + page + '&bpdsi='+ bpdsi+ '&bempresa='+ bempresa
