...
@foreach ($carnes as $c)
            ...
            <tr>
                ...
                @if($hola==4)
                <td colspan="2" style="font-size:8pt; width:160px; height:17px; text-align:center"><strong> CERTIFICACIÓN # P-{{$c->numero}} <br>COMPETENCIA TÉCNICA</strong></td>
                @else
                    @if($c->idtipo_certificado==8 || $c->idtipo_certificado==9)
                    <td colspan="2" style="font-size:8pt; width:160px; height:17px; text-align:center"><strong> CERTIFICATION # P-{{$c->certificado}} <br>TECHNICAL COMPETENCE</strong> <br/></td>
                    @else
                    <td colspan="2" style="font-size:8pt; width:160px; height:17px; text-align:center"><strong> CERTIFICACIÓN # P-{{$c->certificado}} <br>COMPETENCIA TÉCNICA</strong></td>
                    @endif
                @endif
            ...
            <tr>
                ...
                @else
                <td style="font-size:8pt; width:38px; height:17px">Emitido a:</td>
                @endif
            ...
            <tr>
                <td style="width:40px; font-size:8pt"></td>
                <td style="font-size:8pt; width:35px">Empresa: </td>
            ...
            <tr>
                ...
                @else
                <td colspan="2" style="font-size:5pt; width:170px; text-align:center">La persona nombrada ha completado con éxito los <br> exámenes teórico y práctico como: </td>
                @endif
            </tr>
            <tr>
                <td colspan="1" style="width:2px"></td>
                <td colspan="1" style="width:73px"><br><br><br><br>
            ...
            @endif
                ...
                <td colspan="2" style="font-size:8pt; width:165px; text-align:center; height:45px">{!! $c->designacioncarne !!}</td>
            </tr>
