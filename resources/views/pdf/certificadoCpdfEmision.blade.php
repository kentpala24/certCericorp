...
<style>
    ...
    <tr>
        <td colspan="9"></td>
        <td colspan="7" style="height:18px">Certificado N°: {!! strtoupper(str_replace('/', '|', $c->cod_certificado)) !!}</td>
        
    </tr>
    <tr>
        <td colspan="4"></td>
        <td colspan="11" style="height:17px"><b style="font-size:15pt;">CERTIFICADO DE EVALUACIÓN DE COMPETENCIA</b><br></td>
        <td colspan="1"></td>
    </tr>
