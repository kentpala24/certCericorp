...
<style>
    ...
    <tr>
        <td colspan="9"></td>
        <td colspan="7" style="height:18px">Certificado N°: CE-ABXXXX-XXX/ABC00</td>
    ...
    <tr>
        ...
        <td colspan="7" class="anchoDetaD4" style="border-bottom: 2px solid #008000;"><b class="tamaSalto">&nbsp;<br></b>{{ date("d/m/Y", strtotime($c->fecha_emision))}}<b class="tamaSalto"><br>&nbsp;</b></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="1" style="width:10px">:</td>
        <td colspan="8" class="anchoDetaD2" style="margin: 20px !important;"><b class="tamaSaltoD">&nbsp;<br></b>{!! strtoupper($c->tipo_equipo) !!}</td>
    </tr>
    <tr>
        <td colspan="2" style="width:95px"></td>
        <td colspan="5" class="anchoDetaI"><b class="tamaSalto">&nbsp;<br></b><b>PROPIETARIO </b></td>
        <td colspan="1" style="width:10px">:</td>
        <td colspan="8" class="anchoDetaD3"><b class="tamaSalto">&nbsp;<br></b>{!! strtoupper($c->propietario) !!}</td>
    </tr>
    <tr>
        <td colspan="2" style="width:95px"></td>
        <td colspan="5" class="anchoDetaI"><b class="tamaSalto">&nbsp;<br></b><b>MARCA </b></td>
        <td colspan="1" style="width:10px">:</td>
        <td colspan="8" class="anchoDetaD3"><b class="tamaSalto">&nbsp;<br></b>{!! strtoupper($c->marca) !!}</td>
    </tr>
    <tr>
        <td colspan="2" style="width:95px"></td>
        <td colspan="5" class="anchoDetaI"><b class="tamaSalto">&nbsp;<br></b><b>MODELO </b></td>
        <td colspan="1" style="width:10px">:</td>
        <td colspan="8" class="anchoDetaD3"><b class="tamaSalto">&nbsp;<br></b>{!! mb_strtoupper($c->modelo, 'UTF-8') !!}</td>
    </tr>
    <tr>
        <td colspan="2" style="width:95px"></td>
        <td colspan="5" class="anchoDetaI"><b class="tamaSalto">&nbsp;<br></b><b>NUMERO DE SERIE </b></td>
        <td colspan="1" style="width:10px">:</td>
        <td colspan="8" class="anchoDetaD3"><b class="tamaSalto">&nbsp;<br></b>{!! mb_strtoupper($c->serie, 'UTF-8') !!}</td>
    </tr>
    <tr>
        <td colspan="2" style="width:95px"></td>
        <td colspan="5" class="anchoDetaI"><b class="tamaSalto">&nbsp;<br></b><b>CÓDIGO DE INDENTIFICACIÓN INTERNO </b></td>
        <td colspan="1" style="width:10px">:</td>
        <td colspan="8" class="anchoDetaD3"><b class="tamaSalto">&nbsp;<br></b>{!! mb_strtoupper($c->cod_interno, 'UTF-8') !!}</td>
    </tr>
    <tr>
        <td colspan="2" style="width:95px"></td>
        <td colspan="5" class="anchoDetaI"><b class="tamaSalto">&nbsp;<br></b><b>FABRICANTE Y PROCEDENCIA </b></td>
        <td colspan="1" style="width:10px">:</td>
        <td colspan="8" class="anchoDetaD3"><b class="tamaSalto">&nbsp;<br></b>{!! mb_strtoupper($c->fabricante, 'UTF-8') !!}</td>
    </tr>
    @php($indi=0)
    ...
    <tr>
        ...
        <td colspan="8" style="{{ $indi == 0 ? 'border-bottom: 2px solid #008000' : '' }}" class=" {{ $indi == 0 ? 'anchoDetaD4' : 'anchoDetaD3' }}"><b class="tamaSalto">&nbsp;<br></b>{!! mb_strtoupper($c->anio, 'UTF-8') !!}@if($indi == 0)<b class="tamaSalto"><br>&nbsp;</b>@endif</td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="8" style="{{ $indi == 1 ? 'border-bottom: 2px solid #008000' : '' }}" class=" {{ $indi == 1 ? 'anchoDetaD4' : 'anchoDetaD3' }}"><b class="tamaSalto">&nbsp;<br></b>{!! mb_strtoupper($c->resultado1, 'UTF-8') !!} @if($indi == 1)<b class="tamaSalto"><br>&nbsp;</b>@endif</td>
    ...
    @endif
        ...
        <tr>
            ...
            <td colspan="8" style="{{ $indiPara == 0 ? 'border-bottom: 2px solid #008000' : '' }}" class=" {{ $indiPara == 0 ? 'anchoDetaD4' : 'anchoDetaD3' }}"><b class="tamaSalto">&nbsp;<br></b>
    ...
    @if($c->tasa_prueba != '-')
        ...
        <tr>
            ...
            <td colspan="8" style="{{ $indiPara == 1 ? 'border-bottom: 2px solid #008000' : '' }}" class=" {{ $indiPara == 1 ? 'anchoDetaD4' : 'anchoDetaD3' }}"><b class="tamaSalto">&nbsp;<br></b>
    ...
    @if($c->longitud_pluma != '-')
        <tr>
            ...
            <td colspan="8" style="{{ $indiPara == 2 ? 'border-bottom: 2px solid #008000' : '' }}" class=" {{ $indiPara == 2 ? 'anchoDetaD4' : 'anchoDetaD3' }}"><b class="tamaSalto">&nbsp;<br></b>
    ...
    @if($c->angulo_pluma != '-')
        <tr>
            ...
            <td colspan="8" style="{{ $indiPara == 3 ? 'border-bottom: 2px solid #008000' : '' }}" class=" {{ $indiPara == 3 ? 'anchoDetaD4' : 'anchoDetaD3' }}"><b class="tamaSalto">&nbsp;<br></b>
