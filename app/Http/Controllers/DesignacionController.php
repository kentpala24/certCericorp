...
class DesignacionController extends Controller
{
    ...
    {  
        ...
        if($buscar==''){
            ...
            'designacions.normativa_ingles','designacions.normativa_espanol','designacions.estado','tipo_certificados.id as idtipo_certificado','tipo_certificados.nombre')->where('designacions.sede','=',1)
